<h2><a href="https://leetcode.com/problems/sign-of-the-product-of-an-array/?envType=problem-list-v2&envId=math">1950. Sign of the Product of an Array</a></h2><h3>Easy</h3><hr><p>Implement a function <code>signFunc(x)</code> that returns:</p>
