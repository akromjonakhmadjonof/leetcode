<h2><a href="https://leetcode.com/problems/count-largest-group/?envType=problem-list-v2&envId=hash-table">1500. Count Largest Group</a></h2><h3>Easy</h3><hr><p>You are given an integer <code>n</code>.</p>
